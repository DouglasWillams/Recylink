...
// Configuração do Geocoder (Usando Nominatim/OpenStreetMap como serviço gratuito)
...
// ✅ CRÍTICO: Criar Ponto de Coleta (Com Geocodificação)
exports.createPoint = async (req, res) => {
    const userId = req.user.userId; // ID do usuário logado (vem do Token JWT)
    const { nome, full_address, tipo_material } = req.body; // Recebe o endereço completo
...
// Excluir Ponto de Coleta (Apenas o Criador pode deletar)
