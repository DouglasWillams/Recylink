...
        let rawText = '';
        ...
        // ⭐ NOVO: Tenta ler o JSON; se falhar (ex: erro de proxy), tenta ler como texto. ⭐
        try { 
            ...
            if (contentType && contentType.includes('application/json')) {
             ...
             // Se falhar no JSON, o rawText já pode estar lido, ou tentamos ler abaixo se necessário.
        }
        
        if (!response.ok) {
            // Se o JSON falhou, mas temos texto (ex: Vercel retornando "FUNCTION_INVOCATION_FAILED"), usamos a mensagem de texto
