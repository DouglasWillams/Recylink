...
const API_BASE_URL = 'http://localhost:3000/api'; // Base da API (Express)
...
async function fetchPoints() {
    ...
    try {
        // ⭐ CORREÇÃO APLICADA: Adicionando o prefixo '/mapa' ⭐
...
async function handleCreateSubmit(e) {
    ...
    //  ✅  CR Í TICO: Capturar APENAS os novos campos (nome, endere ç o completo e material)
    const newPointData = {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 3.  ✅  NOVO: Anexar o listener de pesquisa ao input
    const searchInput = document.getElementById('search-input');
    if (searchInput) {
