...
async function checkRegistrationStatus(eventId) {
    ...
    try {
        // ⭐ CORREÇÃO APLICADA: Incluindo o prefixo /evento ⭐
...
async function fetchEventDetails(eventId, container, form) {
    try {
        // ⭐ CORREÇÃO APLICADA: Incluindo o prefixo /evento no detalhe ⭐
        // 1. Carrega os detalhes do evento
...
async function handleInscricaoSubmit(e, eventId, eventTitle) {
    ...
    try {
        // ⭐ CORREÇÃO APLICADA: Incluindo o prefixo /evento no POST de inscrição ⭐
